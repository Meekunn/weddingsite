            ...
            <Flex justify={"center"} align="center">
                <Flex direction={{ base: "column", md: "row" }} gap={{ base: 10, xl: 24 }} justify={{ md: "space-around" }} w={{ lg: "75%" }}>
                    <Flex direction="column" gap={6}>
                        ...
                        <Text fontSize={"md"} letterSpacing={"wide"}>
                            She's dedicated, dependable, elegant, ambitious and a true believer. I call her my sweet Baby Girl, My Olori Laafin Kolade, My
                            heartbeat, My best friend.
                            <br />
                            .<br />
                            .<br />
                            wait... all that no complete if i no mention say, she dey get coconut head sometimes sha 😂.
                            <br />I love you so much my darling, and I am exicted to be taking this next step with you.
                        </Text>
                    </Flex>
                    <Flex direction="column" gap={4} zIndex={10}>
                        ...
                        <Text fontSize={"md"} letterSpacing={"wide"}>
                            My Sweet sweet Akolade… Olowo Ori mi …My Everything wrapped in One Being.
                            <br />
                            Thank you for being a home that makes me feel comfortable, safe , happy, lots of Laughters. You are so loving, dependable, caring,
                            thoughtful, best friend, My big-headed sugar zaddy….. At every Seasons ahead, I would choose you over and over again, God by our
                            side.
